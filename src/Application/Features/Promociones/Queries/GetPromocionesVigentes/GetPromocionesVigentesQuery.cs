...
namespace Application.Features.Promociones.Queries.GetAllPromocionesVigentes
{
    ...
    {
        public class GetPromocionesQueryHandler : IRequestHandler<GetPromocionesVigentesQuery, Response<IEnumerable<Promocion>>>
        {
            private readonly IPromocionRepositoryAsync _promocionRepository;
            public GetPromocionesQueryHandler(IPromocionRepositoryAsync promocionRepository)
            {
